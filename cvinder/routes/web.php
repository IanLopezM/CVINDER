...
Route::get("/worker", [WorkerController::class, "index"])->name("worker.index");                            //half(interficie) done(functioning)    ENDED!
Route::get("/worker/profile", [WorkerController::class, "profile"])->name("worker.profile");                //done(interficie) done(functioning)    ENDED!
Route::get("/worker/matches", [WorkerController::class, "matches"])->name("worker.matches");                //half(interficie) done(functioning)    ENDED!
...
Route::get("/enterprise/return", [EnterpriseController::class, "return"])->name("enterprise.return");      //**************** done(functioning)     ENDED!

Route::get("/offer", [OfferController::class, "index"])->name("offer.index");                               //half(interficie) done(functioning)    ENDED!
Route::get("/offer/profile", [OfferController::class, "profile"])->name("offer.profile");                   //done(interficie) done(functioning)    ENDED!
Route::get("/offer/matches", [OfferController::class, "matches"])->name("offer.matches");                   //half(interficie) done(functioning)    ENDED!
